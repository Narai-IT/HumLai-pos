...
> **มีเว็บ/API ของระบบอื่นที่มีโดเมน https เข้าจากนอกได้อยู่แล้วหรือเปล่า?**
> ถ้ามี ใช้ [`API-BEHIND-EXISTING-DOMAIN.md`](API-BEHIND-EXISTING-DOMAIN.md) แทนจะง่ายกว่า —
> ไม่ต้องลงโปรแกรมเพิ่ม ไม่ต้องมีโดเมนใหม่ แค่เพิ่มกฎส่งต่อในเว็บเซิร์ฟเวอร์ที่มีอยู่
